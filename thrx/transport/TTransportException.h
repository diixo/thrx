...
#ifndef _TRANSPORT_TTRANSPORTEXCEPTION_H_
#define _TRANSPORT_TTRANSPORTEXCEPTION_H_ 1
 ...
 *
 */
class TTransportException : public thrx::TException
{
public:
  /**
  ...
  TTransportException() : thrx::TException(), type_(UNKNOWN) {}

  TTransportException(TTransportExceptionType type) : thrx::TException(), type_(type) {}

  TTransportException(const std::string& message)
   : thrx::TException(message)
   , type_(UNKNOWN)
  {}
  ...
  TTransportException(TTransportExceptionType type, const std::string& message, int errno_copy)
   : thrx::TException(message + ": " + TOutput::strerror_s(errno_copy))
   , type_(type)
  {}
...
#endif // #ifndef _TRANSPORT_TTRANSPORTEXCEPTION_H_
