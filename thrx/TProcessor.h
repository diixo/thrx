...
#ifndef _TPROCESSOR_H_
#define _TPROCESSOR_H_ 1
...
private:
  thrx::TProcessorEventHandler* handler_;
  void* context_;
  const char* method_;
};
...
public:
  ...
  bool process(std::shared_ptr<thrx::protocol::TProtocol> io, void* connectionContext) {
