...
#include "TConcurrentClientSyncInfo.h"
...
using namespace ::thrx::concurrency;
...
TConcurrentClientSyncInfo::TConcurrentClientSyncInfo() :
  ...
  seqidPending_(0),
  fnamePending_(),
  mtypePending_(::thrx::protocol::T_CALL)
{
...
{
  throw thrx::TApplicationException(
...
{
  throw thrx::transport::TTransportException(
    thrx::transport::TTransportException::NOT_OPEN,
