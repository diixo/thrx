 ...
 * under the License.
 */
#ifndef _TCONCURRENTCLIENTSYNCINFO_H_
#define _TCONCURRENTCLIENTSYNCINFO_H_ 1
...
class TConcurrentClientSyncInfo {
private: // typedefs
  typedef std::shared_ptr< ::thrx::concurrency::Monitor> MonitorPtr;
...
public:
  ...
  bool getPending(std::string& fname,
                  ::thrx::protocol::TMessageType& mtype,
  ...
  ::thrx::concurrency::Mutex& getReadMutex() { return readMutex_; }
  ::thrx::concurrency::Mutex& getWriteMutex() { return writeMutex_; }
...
private: // functions
  MonitorPtr newMonitor_(
      const ::thrx::concurrency::Guard& seqidGuard); /* requires seqidMutex_ */
  void deleteMonitor_(const ::thrx::concurrency::Guard& seqidGuard, MonitorPtr& m);
      /*noexcept*/ /* requires seqidMutex_ */
  void wakeupAnyone_(
      const ::thrx::concurrency::Guard& seqidGuard);           /* requires seqidMutex_ */
  void markBad_(const ::thrx::concurrency::Guard& seqidGuard); /* requires seqidMutex_ */
  void throwBadSeqId_();
...
private: // data members
  ...
  ::thrx::concurrency::Mutex seqidMutex_;
  ...
  ::thrx::concurrency::Mutex writeMutex_;

  ::thrx::concurrency::Mutex readMutex_;
  // begin readMutex_ protected members
  bool recvPending_;
  bool wakeupSomeone_;
  int32_t seqidPending_;
  std::string fnamePending_;
  ::thrx::protocol::TMessageType mtypePending_;
...
#endif // _TCONCURRENTCLIENTSYNCINFO_H_
