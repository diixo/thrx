...
#ifndef _TRANSPORT_TBUFFERTRANSPORTS_H_
#define _TRANSPORT_TBUFFERTRANSPORTS_H_ 1
...
public:
  ...
  uint32_t readAll(uint8_t* buf, uint32_t len) {
    ...
    return thrx::transport::readAll(*this, buf, len);
  }
...
#endif // #ifndef _TRANSPORT_TBUFFERTRANSPORTS_H_
