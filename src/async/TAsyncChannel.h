...
#ifndef _ASYNC_TASYNCCHANNEL_H_
#define _ASYNC_TASYNCCHANNEL_H_ 1
...
namespace thrx {
namespace async {
using thrx::transport::TMemoryBuffer;
...
public:
  ...
  virtual void sendMessage(const VoidCallback& cob,
                           thrx::transport::TMemoryBuffer* message) = 0;
  ...
  virtual void sendAndRecvMessage(const VoidCallback& cob,
                                  thrx::transport::TMemoryBuffer* sendBuf,
                                  thrx::transport::TMemoryBuffer* recvBuf);
};
}
}

#endif // #ifndef _ASYNC_TASYNCCHANNEL_H_
